package keyboard.emoji_library.Actions;
...
import keyboard.emoji_library.Helper.EmojiconEditText;
import keyboard.emoji_library.Helper.EmojiconGridView;
import keyboard.emoji_library.Helper.EmojiconsPopup;
import keyboard.emoji_library.R;

public class EmojiIconActions {
     ...
     */
    public EmojiIconActions(Context ctx, View rootView, EmojiconEditText emojiconEditText, ImageView emojiButton) {
     ...
     */
    public EmojiIconActions(Context ctx, View rootView, EmojiconEditText emojiconEditText, ImageView emojiButton, String iconPressedColor, String tabsColor, String backgroundColor) {
        this.emojiconEditText = emojiconEditText;
        this.emojiButton = emojiButton;
        this.context = ctx;
        this.rootView = rootView;
